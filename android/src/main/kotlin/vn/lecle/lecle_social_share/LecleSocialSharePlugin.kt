...
class LecleSocialSharePlugin : FlutterPlugin, MethodCallHandler, ActivityAware {
    ...
    private fun shareFilesToTikTok(arguments: Map<*, *>, result: Result) {
        ...
        val hashtag = arguments["hashtag"] as? ArrayList<String?>
        val fileType = arguments["fileType"] as String
        val dstPath = arguments["dstPath"] as? String
        val fileProviderPath = arguments["fileProviderPath"] as String
        val shareFormat = arguments["shareFormat"] as? String
        val landedPageType = arguments["landedPageType"] as? String
        val activityName = arguments["activityName"] as? String
...
//            dstPath,
//        )
        TikTokSocialMediaShare.shareFilesToTikTokTemp(
                activity,
                result,
                fileType,
                shareFormat ?: "normal",
    ...
    private fun tiktokInstalled(result: Result) {
        result.success(TikTokSocialMediaShare.tiktokInstalled(activity))
    }
}
